...
def plan_tasks_with_intervals(gcp_project_id: str, indexer_url: str, bq_dataset: str, start_timestamp: int, end_timestamp: int, granularity: int):
    storage = TasksWithIntervalStorage(gcp_project_id)
...
def plan_tasks_without_intervals(gcp_project_id: str, indexer_url: str, bq_dataset: str):
    storage = TasksWithoutIntervalStorage(gcp_project_id)
    planner = TasksPlanner()
