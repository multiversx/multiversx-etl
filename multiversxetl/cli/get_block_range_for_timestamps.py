...
def get_hyperblock_range_for_timestamps(provider_uri: str, start_timestamp: int, end_timestamp: int, output: Any):
    ...
    start_block, end_block = service.get_hyperblock_range_for_timestamps(start_timestamp, end_timestamp)
